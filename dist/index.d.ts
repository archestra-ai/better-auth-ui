...
import { R as Refetch, T as Team, A as AnyAuthClient } from './auth-hooks-CS2TsYLl.js';
export { a as AuthHooks, b as TeamMember } from './auth-hooks-CS2TsYLl.js';
import * as _better_fetch_fetch from '@better-fetch/fetch';
export { g as getViewByPath } from './utils-C5R37WDe.js';
export { A as AuthMutators } from './auth-mutators-Ci-MWyBx.js';
 ...
 */
declare function CreateTeamDialog({ classNames, localization: localizationProp, organizationId, onOpenChange, ...props }: CreateTeamDialogProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function TeamCell({ classNames, team, localization }: TeamCellProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function TeamsCard({ className, classNames, localization, ...props }: SettingsCardProps): react_jsx_runtime.JSX.Element;
