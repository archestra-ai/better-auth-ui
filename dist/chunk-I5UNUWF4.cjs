...
var AuthUIProvider = ({
  ...
  const account = _react.useMemo.call(void 0, () => {
    ...
    if (accountProp === true || accountProp === void 0) {
      return {
        basePath: "/account",
        fields: ["image", "name"],
        viewPaths: _chunkYNX7XHHIcjs.accountViewPaths
      };
    }
    ...
    return {
      ...
      viewPaths: { ..._chunkYNX7XHHIcjs.accountViewPaths, ...accountProp.viewPaths }
    };
  }, [accountProp]);
  ...
  const organization = _react.useMemo.call(void 0, () => {
    ...
    if (organizationProp === true) {
      return {
        ...
        viewPaths: _chunkYNX7XHHIcjs.organizationViewPaths,
        customRoles: []
      };
    }
    let logo;
    ...
    return {
      ...
      viewPaths: {
        ..._chunkYNX7XHHIcjs.organizationViewPaths,
  ...
  const viewPaths = _react.useMemo.call(void 0, () => {
    return { ..._chunkYNX7XHHIcjs.authViewPaths, ...viewPathsProp };
  }, [viewPathsProp]);
  const localization = _react.useMemo.call(void 0, () => {
    return { ..._chunkYNX7XHHIcjs.authLocalization, ...localizationProp };
  }, [localizationProp]);
